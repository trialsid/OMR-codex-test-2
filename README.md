...
- `roll_columns` – Number of digits in the roll number (e.g., 3 for roll numbers 000-999)
- `roll_rows` – Digit range for each roll column (typically 10 for digits 0-9)
...
layout = SheetLayout(
    class_options=5,
    roll_columns=4,  # 4-digit roll numbers
    roll_rows=10,
    set_options=4,
